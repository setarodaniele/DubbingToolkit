...
def seleziona_lingua(messages, settings=None, context="translation_source", default=None):
    ...
    def save_settings(settings_dict, selected_context=None, selected_value=None):
        # Unidirectional sync: Translation_Target_Lang → Dubbing_Lang
        if selected_context == "translation_target" and selected_value is not None:
            settings_dict["Dubbing_Lang"] = selected_value
    ...
    if quick_langs:
        ...
        while True:
            ...
            if settings and settings_key:
                ...
                save_settings(settings, selected_context=context, selected_value=selected_lang)
