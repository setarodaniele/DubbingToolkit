...
# ============================================================
# Version: 1.2 (dual-mode build system)
#
# Purpose:
...
if ($DryRun) {
    Write-Host " [DRY RUN - SIMULAZIONE, NESSUN FILE VERRÀ CREATO]"
}
