...
def offer_open_folder(folder, messages):
    """Prompt the user to open an output folder in Explorer. Default: no."""
    import os
    from pathlib import Path
    from core.input_parsing import is_yes
    prompt = getattr(messages, "OPEN_FOLDER_prompt", "Open output folder in Explorer? (y/N): ")
